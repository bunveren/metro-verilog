...
HD_PWD='C:/Users/90533/Documents/vivado/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log metro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source metro.tcl -notrace
