...
HD_PWD='C:/Users/90533/Documents/vivado/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log metro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source metro.tcl
